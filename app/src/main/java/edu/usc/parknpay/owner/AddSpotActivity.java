...
public class AddSpotActivity extends TemplateActivity {
    ...
    public void addSpot(View view) {
        if (ContextCompat.checkSelfPermission(edu.usc.parknpay.owner.AddSpotActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(edu.usc.parknpay.owner.AddSpotActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
        }
        else {
        }
        progress.show();
